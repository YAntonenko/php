...
<html lang="en">
  ...
  <body>
    ...
    <h2>Pildid</h2>
      <div class="conteiner">
        <div class="row">
          <div class="col-sm-4"><img src="pic/devlin.jpg" alt=""></div>
          <div class="col-sm-4"><img src="pic/freeland.jpg" alt=""></div>
          <div class="col-sm-4"><img src="pic/gabriel.jpg" alt=""></div>
          <div class="col-sm-4"><img src="pic/peterus.jpg" alt=""></div>
          <div class="col-sm-4"><img src="pic/prentice.jpg" alt=""></div>
        </div>
      </div>
  ...
  <h2>Palgad</h2>
    <form action="#">
      ...
      <input type="submit" value="Eemalda firme">
    </form>
  ...
  <h2>Tüdrukud</h2>
    <?php 
      $nimed = array('Mari', 'Anabel', 'Anna', 'Merle', 'Mia', 'Brit', 'Karin', 'Eneli'); 
